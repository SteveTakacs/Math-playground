# Math-playground
A collection of famous mathematical problems and their solutions, explored through Python simulations and code.

In this collection we will see a simulation for the following Math problems:

1/ Monty Hall problem (in 3 version)
-Original (Choosing between 2 Doors, while starting with 3)
-With 1000 Doors (Choosing between 2 Doors, while starting with 3)
-With French Cards (Choosing between 2 Doors, while starting with 3)

(In the last 2 example our "gut feeling" is more accurate than with the original game, telling us that we should switch)

2/ The effect of seving in squash
If we assume that between 2 equal players, a serve means 5% advantage, will starting always mean that the player has 55% chance of winning? Or will the effect of serving accumulate to an even bigger advantage?
